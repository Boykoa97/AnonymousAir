...
function flightDescriptionQuery(param){
...
//~~~~~~~~~~~~~~~~~~~~EDIT~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
var sql = 'SELECT COUNT(OnFlight.seatNo) as PopularFlights, city FROM Flight JOIN \
Airport JOIN OnFlight WHERE OnFlight.fid = Flight.fid AND OnFlight.deptTime = \
Flight.deptTime AND Flight.arr = Airport.aid GROUP BY city ORDER BY PopularFlights DESC LIMIT 3';
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
module.exports.flightDescriptionQuery = function(param){return flightDescriptionQuery(param);}
